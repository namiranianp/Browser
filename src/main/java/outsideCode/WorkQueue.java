...
public class WorkQueue {
	...
	public synchronized void finish() {
		try {
			...
			System.err.println("thread: " + this.toString() + " was interrupted while waiting");
		}
	}
	...
	/**
	 * Increments the pending variable to show that there is either work to be
	 * done or work that is currently being done
	 */
	...
	/**
	 * Decrements the pending variable to show that there is no more work to be
	 * done or being done by this work queue
	 */
